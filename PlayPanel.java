...
public class PlayPanel extends JPanel{
  ...
  /*
   * PlayPanel which creates the panel that holds the grid of buttons and the
   ...
   * @return ImageIcon
   * @parameters String path, String description
   */
  ...
  private class ButtonListener implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e)
    {
      ...
      if (e.getSource() == playbutton)  {
        ...
        for (int i=0; i<8; i++){
          // if column is NOT empty, play, otherwise skip this column:
          if (PPlayer.emptyColumn(i) == false){
